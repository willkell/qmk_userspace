...
[_QWERTY] = LAYOUT(
  ...
  KC_NO, KC_NO,       LT(_MOUSE, KC_ENT) ,       LT(_NAV,      KC_SPC),   OS_LSFT,MO(_SYM),      LT(_NUM,      KC_BSPC),        LT(_FUN, KC_DEL), KC_NO, KC_NO
),
...
[_ENTHIUM] = LAYOUT(
  ...
  KC_NO, KC_NO,       LT(_MOUSE, KC_ESC) ,       LT(_NAV,      KC_SPC),   OS_LSFT,LT(_SYM, KC_BSPC),      LT(_NUM,      KC_R),        LT(_FUN, KC_DEL), KC_NO, KC_NO
    ),
