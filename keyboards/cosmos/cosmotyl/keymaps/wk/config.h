...
// The underlying LAYOUT_5x6_5 mirrors QMK's handwired/dactyl_manuform/5x6_5:
// same key order and coordinates. The thumb cluster is laid out per side as
//   [XL0 XL1] [thumb-top L30 L31 L32]      (row 4)
//             [thumb-bottom L40 L41]        (row 5)
// with the right hand mirrored, so the universal params are fed to the
// dactyl-order slots below.
#define LAYOUT_wk( \
...
LAYOUT_5x6_5( \
    ...
    L10, L11, L12, L13, L14, L15,  R10, R11, R12, R13, R14, R15, \
    L20, L21, L22, L23, L24, L25,  R20, R21, R22, R23, R24, R25, \
    XL0, XL1, L30, L31, L32,       R32, R31, R30, XR0, XR1,      \
    L40, L41,                      R41, R40                      \
)
